    ...
    <body>
        <div class="box box-primary">
            <div class="box-header" style="color: #0075b0">
                ...
                <h2 class="box-title">Unidades</h2>
            ...
            <div class="box-body" style="height: auto">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td>Modulo Cobrança</td>
                            <td>Orion - Serviços Póstumos</td>
                            <td>
                                <a href="#" title="Editar" data-toggle="modal" data-target="#delete-modal" style="font-size: 18px; color: #D50000; text-align: center">
                                    <i class="material-icons">delete</i>
                                </a>
                            </td>                            
                        </tr>
                        <tr>
                            <td>Modulo Comercial</td>
                            <td>Orion - Serviços Póstumos</td>
                            <td>
